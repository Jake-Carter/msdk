...
void UriBeaconStart(void)
{
  ...
  if (WsfNvmReadData((uint64_t)URI_BEACON_PARAM_LOCK_STATE, (uint8_t *)&lockState, sizeof(lockState), NULL) )
  {
  ...
  else if (WsfNvmReadData((uint64_t)URI_BEACON_PARAM_URI_DATA, &uriData[0], sizeof(uriData), NULL))
  {
  ...
  if (WsfNvmReadData((uint64_t)URI_BEACON_PARAM_URI_FLAGS, (uint8_t *)&uriFlags, sizeof(uriFlags), NULL))
  {
  ...
  if (WsfNvmReadData((uint64_t)URI_BEACON_PARAM_ADVERTISED_TX_POWER_LEVELS, (uint8_t *)&uriBeaconAdvertisedTxPwrLevels, sizeof(uriBeaconAdvertisedTxPwrLevels), NULL))
  {
  ...
  if (WsfNvmReadData((uint64_t)URI_BEACON_PARAM_TX_POWER_MODE, (uint8_t *)&uriBeaconTxPwrMode, sizeof(uriBeaconTxPwrMode), NULL))
  {
  ...
  if (WsfNvmReadData((uint64_t)URI_BEACON_PARAM_BEACON_PERIOD, (uint8_t *)&beaconPeriod, sizeof(beaconPeriod), NULL))
  {
  ...
  if (WsfNvmReadData((uint64_t)URI_BEACON_PARAM_LOCK, &lock[0], sizeof(lock), NULL))
  {
